...
- **N50 PRO OMNI** (Class ID: `ss87ia` | Model: `EULER_IND_WH` | UILogicId: `eulerh_ww_h_eulerh5` | SmartType: `MQ_APM`)
...
- **M12 PRO Gen2** (Class ID: `fbxfh9` | Model: `EULER_BK_AMR_YEEDI` | UILogicId: `eulerseh_ww_h_yeulerh5` | SmartType: `MQ_APM`)
