 ...
 * @extends VacBotCommand
 */
export class GetMapInfo_V2_Yeedi {
 ...
 * @extends VacBotCommand
 */
export class GetAIMap {
}
/**
 * Set area (sub set) data for the given map
 */
export class SetMapSet_V2 {
